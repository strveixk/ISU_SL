        ...
        while (running) {
            ...
            if (option.equals("1")) { // prompts service creation
                    ...
                    if (categoryChoice >= 0 && categoryChoice < displayedCategories.size()) {
                        ...
                        if (matches.size() == 0) {
                            ...
                            for (int i = 0; i < matches.size(); i++) {
                                ...
                                System.out.printf("%d. %s - $%.2f/hr %s%n", (i + 1), serviceNames.get(idx), serviceRates.get(idx), status);
                            }
                ...
                for (int i = 0; i < cart.size(); i++) {
                    ...
                    total += subtotal;
                    System.out.printf("%d. %s - $%.2f/hr x %.1f hrs = $%.2f%n", (i + 1), serviceNames.get(idx), serviceRates.get(idx), hours, subtotal);
                }
